		...
		<h1 align = center>Novedades</h1>
			...
			<div class="row">
				<div class="col-sm-6 illust-box">
					...
					<div align="center">
						<img id="ilust" class="img-rounded" src="novedades/img/otoño.jpg" width="200" height="205">
						<div class="col-sm-8">
							<div class="progress">
					...
					<div align="center">
						<img id="ilust" class="img-rounded" src="novedades/img/kingkong.jpg" width="200" height="205">
						<div class="col-sm-8">
							<div class="progress">
					...
					<div align="center">
						<img id="ilust" class="img-rounded" src="novedades/img/vacas.jpg" width="200" height="205">
						<div class="col-sm-8">
							<div class="progress">
					...
					<div align="center">
						<img id="ilust" class="img-rounded" src="novedades/img/lostresmeones.jpg" width="200" height="205">
						<div class="col-sm-8">
							<div class="progress">
								<div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width:60%">
									<span class="sr-only">6/10</span>
			...
			<ul class="pager">
			  <li class="previous"><a href="novedadesp2.html">Previous</a></li> 

				<ul class="pagination pagination-sm" align="center">
				  <li><a href="novedades.html">1</a></li>
				  <li><a href="novedadesP2.html">2</a></li>
				  <li class="active"><a href="novedadesP3.html">3</a></li>
			  ...
			  <li class="next"><a href="novedadesP4.html">Next</a></li>
			</ul>
