...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2017 a las 13:51:45
...
ALTER TABLE `posts`
  ...
  ADD CONSTRAINT `posts_ibfk_2` FOREIGN KEY (`post_id`) REFERENCES `comments` (`comment_post`) ON DELETE CASCADE ON UPDATE CASCADE;
