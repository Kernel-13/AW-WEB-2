...
<body>
    ...
    <div class="container">
		...
		<div id="cabecera" class="row"> 
            <div class="col-lg-12">
                <h3>Lista de Ã©xitos de la semana
                        <small id="subt">Â¡Lo Ãºltimo!</small>                        
                </h3>
            </div>
        </div>
        <hr>                     
            ...
            while ($row = mysqli_fetch_row($resultado)){                                          
				...
				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
					<h4 class="centar">'.$row[11].'</h4>
					 ...
					 <a class="btn btn-primary" href="song.php">MÃ¡s informaciÃ³n<span class="glyphicon glyphicon-chevron-right"></span></a>
