					...
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<div class="col-md-12">
											<input class="form-control" type="text" name="title" required="required" placeholder="Titulo de la Canción">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-12">
									...
									<div class="form-group">
										<div class="col-md-12">
											<textarea class="form-control" id="descBox" name="description" required="required" placeholder="Una breve descripción de la cancion"></textarea>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6" id="left-side">
									<div class="form-group">
										<div class="col-md-12">
											<label>Selecciona la cancion que deseas publicar</label>
											<div class="new-input">
												<input id="song" type="file" name="file" required="required">
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-12">
											<label>Escoge una imagen para usarla como 'cover' (Debe ser cuadrada)</label>
											<div class="new-input">
							...
							<div class="row section">
								<div class="col-lg-12">
									<div >
										<input id="submitButton" class="btn btn-success" type="submit" name="submit" value="Subir Canción">
									</div>				
								</div>
							</div>
						</div>
