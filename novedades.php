					...
					echo "<div class='col-sm-4 illust-box'>";
	                    ...
	                    while($contador<$tamañoColumna &&  $registro = $resultado->fetch_array(MYSQLI_BOTH)){
	                    	...
	                    	//<!--titulo-->
	                            echo "
	                            	<div class='desc-box-illust'>
			                        	<a  href='illust.php?id=$registro[post_id]'>
			                ...
			                //<!--caja de contenido-->
	                            echo "
	                            	...
	                            	<div class='box media'>
									 	...
									 	<div class='media-body'>
										    <h4 class='media-heading'><a href='user?id=$registro[post_owner]'>$autor[user_name]</a></h4>
											<p>$textoRecortado";
	                            ...
	                            echo "
	                            	<div class='desc-box-illust'>
			                        	<a  href='song.php?id=$registro[post_id]'>
			                        		<h3>$registro[post_title]</h3>
			                        	</a>
			                        </div>";
