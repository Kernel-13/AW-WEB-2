 ...
 */
 ...
 window.onload = function() {
    ...
    cheight = canvas.height - 2,
        ...
        capHeight = 2,
        capStyle = '#fff',
        meterNum = 848 / (10 + 2), //count of the meters
        capYPositionArray = []; ////store the vertical position of hte caps for the preivous frame
        ctx = canvas.getContext('2d'),
        gradient = ctx.createLinearGradient(0, 0, 0, 300);
        gradient.addColorStop(1, '#FF0000');
        gradient.addColorStop(0.5, '#f44286');
    ...
    function resizeCanvas() {
        var divHeight = document.getElementById('song-cover').clientHeight;
        var divWidth = document.getElementById('canvas-div').clientWidth;
        canvas.width = divWidth - 20;
